 <div class="row ">
        ...
        <div class="col-lg-8 mt-12" >
          ...
          <div class="col-lg-2 ">
              <button type="button" class="button button-purple mt-12 pull-right" data-toggle="modal" data-target="#create_sinhvien_info_modal"> Tạo SV</button> 
...
<table class="table">
            ...
            <tbody>
                ...
                <tr ng-repeat="sinhviens in std_ctrl.sinhvien_list">
                    ...
                    <td width = "20%">{{sinhviens.hovaten}}</td>
                    <td width = "20%">{{sinhviens.email}}</td>
                    <td ng-if ="sinhviens.gioitinh=='Male'">{{"Nam"}}</td><td ng-if ="sinhviens.gioitinh!='Male'">{{"Nữ"}}</td>
                    <td width = "20%" >{{sinhviens.Diachi}}</td>                 
                ...
                <td  class="text-right">
                    ...
                    <button  type="button" data-toggle="modal" data-target="#edit_sinhvien_info_modal"  class="button button-blue" ng-click="std_ctrl.edit_sinhvien_info(sinhviens.SV_id)">Edit</button> 
  ...
  <div class="modal fade" id="edit_sinhvien_info_modal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title">Thông tin sửa || {{std_ctrl.sinhvien_info.hovaten}} </h3>
        </div>
        <div class="modal-body" >
         
            <form method="post"  id="edit_sinhvien_info_frm" name="edit_sinhvien_info_frm" ng-submit="std_ctrl.updatesinhvien()">
                   <input ng-model="std_ctrl.sinhvien_info.SV_id" type="hidden" />
            <div class="form-group">
                <label >Họ và Tên</label>
                <input type="text"  ng-model="std_ctrl.sinhvien_info.hovaten"  class="form-control" required maxlength="50">
            </div>
            <div class="form-group">
                <label >Địa chỉ Email</label>
                <input type="email" class="form-control" ng-model="std_ctrl.sinhvien_info.email" required maxlength="50">
            </div>
            <div class="form-group">
              <label >Giới tính</label>
              <select class="form-control" ng-model="std_ctrl.sinhvien_info.gioitinh" >
                  <option value="" selected>Select</option>
                  <option value="Male" >Nam</option>
                  <option value="Female" >Nữ</option>
              </select>
            ...
            <div class="form-group">
                <label >Địa chỉ</label>
                <input type="text" class="form-control" ng-model="std_ctrl.sinhvien_info.Diachi"  maxlength="50">
            </div>
            
            <div class="form-group">
                <label >Quốc gia</label>
                <input type="text" name="country" ng-model="std_ctrl.sinhvien_info.Quocgia" class="form-control"  maxlength="50">
            </div>
                <div class="form-group mb-50">
